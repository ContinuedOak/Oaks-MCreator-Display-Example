...
package com.oakmods.example.block;
...
import com.oakmods.example.procedures.HangingChainNeighbourBlockChangesProcedure;

public class HangingChainBlock extends Block implements SimpleWaterloggedBlock {
	public static final EnumProperty<Direction> FACING = HorizontalDirectionalBlock.FACING;
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public HangingChainBlock(BlockBehaviour.Properties properties) {
	...
	public void neighborChanged(BlockState blockstate, Level world, BlockPos pos, Block neighborBlock, @Nullable Orientation orientation, boolean moving) {
		...
		HangingChainNeighbourBlockChangesProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
}
